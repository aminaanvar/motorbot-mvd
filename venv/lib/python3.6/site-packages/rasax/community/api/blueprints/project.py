...
def blueprint() -> Blueprint:
    ...
    async def profile(request: Request, user: Dict) -> HTTPResponse:
        user_service = UserService(request.ctx.db_session)
    ...
    async def features(request: Request) -> HTTPResponse:
        feature_service = FeatureService(request.ctx.db_session)
    ...
    async def get_domain(request: Request) -> HTTPResponse:
        domain_service = DomainService(request.ctx.db_session)
    ...
    async def get_domain_actions(request: Request, project_id: Text) -> HTTPResponse:
        domain_actions = DomainService(request.ctx.db_session).get_actions_from_domain(
            project_id
        )
