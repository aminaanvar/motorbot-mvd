...
from typing import Text, Optional, List, Dict, Any, Union, NoReturn, cast
...
class EventService(DbService):
    ...
    def _process_tag(
        ...
        return cast(ConversationTag, existing_tag)
    ...
    def delete_conversation_by_id(self, conversation_id: Text) -> None:
        ...
        message_logs = (
            self.query(MessageLog)
            .filter(MessageLog.conversation_id == conversation_id)
            .all()
        )
        if message_logs:
            self.delete_all(message_logs)
